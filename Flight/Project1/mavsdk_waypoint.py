"""
Waypoint starter project for Mavsdk
"""
...
async def run() -> System:  ## definition of an asynchronous function called run
    """
    initializes the drone

    Returns
    -------
    The drone which is type System to use for movement
    """

    drone: System = System()  ## Creates a new system object named drone that can be used later
    ## when calling any type of system methods
    await drone.connect(
        system_address="udp://:14540"
    )  ## The connect function is used to connect the physical drone and the simulated drone.
    ## The system address parameter can be changed to connect to either the real drone, or the
    ## simulator drone.
    ...
    ):  ## Loops over the connection state function to check if drone is properly connected
        ## to the given system address
